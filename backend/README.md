...
## Project Structure
    ...
    ├── testdeployment_dev_49664  # Django project configurations
...
1. Clone this repo and `cd testdeployment_dev_49664`
...
2. Clone this repo and `cd testdeployment_dev_49664`
